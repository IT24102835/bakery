    ...
    <div class="container">
        ...
        <div class="success-card">
            ...
            <div class="success-body">
                ...
                <h4 class="success-title">Order Details Saved Successfully!</h4>
                <p class="message-text">Thank you for your order! We'll start preparing your delicious treats right away. You can track your order status through the View Orders page.</p>
                
                <div class="action-buttons">
                    <a href="home.jsp" class="btn btn-primary">
                        <i class="fas fa-home me-2"></i>Return Home
                    </a>
                    <a href="ViewBakeryOrder.jsp" class="btn btn-success">
